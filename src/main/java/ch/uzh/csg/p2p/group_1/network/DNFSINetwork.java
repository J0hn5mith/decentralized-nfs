...
public interface DNFSINetwork {
    ...
    public boolean keyExists(Number160 key) throws DNFSException.DNFSNetworkNoConnection;

    public Number160 getUniqueKey() throws DNFSException.DNFSNetworkNoConnection;
