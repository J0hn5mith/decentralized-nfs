...
public class DNFSAccessRights {
    ...
    private static class AccessRightByteValues {
        static long OWNER_WRITABLE = 256L;
        static long OWNER_READABLE = 128L;
        static long OWNER_EXECUTABLE = 64L;

        static long GROUP_WRITABLE = 32L;
        static long GROUP_READABLE = 16L;
        static long GROUP_EXECUTABLE = 8L;

        static long OTHER_WRITABLE = 4L;
        static long OTHER_READABLE = 2L;
